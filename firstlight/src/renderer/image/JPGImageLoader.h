#ifndef FLT_JPG_IMAGELOADER_H
#define FLT_JPG_IMAGELOADER_H

#include "config.h"
#include "IImageLoader.h"

//About: some code from irrlicht engine
...
extern "C" 
{	
	#include "externs/jpeglib/jpeglib.h"
	#include <setjmp.h>
}
#endif
