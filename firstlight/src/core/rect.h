	...
	*/
	...
	public:
		...
		rect(T x, T y, T width, T height)
			: UpperLeftCorner(x,y), LowerRightCorner(x+width,y+height) {}
		...
		void set(T x, T y, T width, T height)
		{
			UpperLeftCorner.X = x;
			UpperLeftCorner.Y = y;
			LowerRightCorner.X = x+width;
			LowerRightCorner.Y = y+height;
		}

		void scale(float sclaeX, float scaleY)
		{
			UpperLeftCorner.X *= sclaeX;
			UpperLeftCorner.Y *= scaleY;
			LowerRightCorner.X *= sclaeX;
			LowerRightCorner.Y *= scaleY;
		}
