 ...
 *    in binary compatibility (e.g., when a irrnew feature is added).
 *
...
/* Maintainer: Put irrnew public prototypes here ^, in libpng.3, and project defs */
...
/* Maintainer: Put irrnew private prototypes here ^ and in libpngpf.3 */
